...
export default function CenterPage({ sendMsg, listData }) {
  ...
  const getNodes = () => {
    ...
    for (const data of listData) {
      const node =
        data.type === 2 ? (
          <div className="servererCenter-12">
            <div className="servererCenter-13">
          ...
          <div className="servererCenter-15">
            <div className="servererCenter-16">
              {data.content.startsWith("image:") ? (
                <div
                  style={{
                    float: "left",
  ...
  return (
                    ...
                    <span class="servererCenterInfo-11">
                      <span class="servererCenterInfo-12">
                        <span class="servererCenterInfo-13">
                          BTEX Official Online Customer Service.Excellen …
                        </span>
                      </span>
                    </span>
                ...
                <div class="servererCenterInfo-17">
                  <div class="servererCenterInfo-18">
                    <div class="servererCenterInfo-19">
                      <div class="servererCenterInfo-20"></div>
                      <div class="servererCenterInfo-21">
                            ...
                            <div class="servererCenterInfo-26">
                              <div class="servererCenterInfo-27">
                                <div class="servererCenterInfo-28">
                                  <span class="servererCenterInfo-29">
                                    Hi, this is BTEX’s official online customer
                            ...
                            <div class="servererCenterInfo-32">
                              <div class="servererCenterInfo-33">
                                <div class="servererCenterInfo-34">
                                  <span class="servererCenterInfo-35">
                                    {" "}
                                    ha ha ha{" "}
                                  </span>
                                </div>
              ...
              <div class="servererCenterInfo-41">
                ...
                <div class="servererCenterInfo-44">
                  ...
                  <div class="servererCenterInfo-47">
                    <i class="servererCenterInfo-48"></i>
                  </div>
                </div>
              </div>
    ...
    // <div className="servererCenter-1">
    //   <div className="servererCenter-2">
    //     <div className="servererCenter-9">
    //       <div className="servererCenter-10">
    //         {translate(getText("请直接提交您的问题,等待客服回复即可"))}
    //       </div>
    //     </div>
    //     <div id="msgbox" ref={messagesRef} className="servererCenter-11">
    //       {getNodes()}
    //       <div
    //         style={{
    //           height: "30px",
    ...
    //       ></div>
    //     </div>
    //     <div className="servererCenter-30">
    //       <div className="servererCenter-31">
    //         <Input.TextArea
    //           rows={1}
    //           placeholder={translate(getText("请输入信息内容"))}
    //           className="servererCenter-32"
    //           id="content"
    //           name="content"
    //           value={content}
    //           onChange={(e) => {
    ...
    //         >
    //           <PlusCircleOutlined className="upIcon" />
    //         </Upload>
    //         <Button
    //           className="servererCenter-33"
    //           type="primary"
    //           onClick={() => {
    //             setContent("");
    //             sendMsg(content);
