...
export default function ListPage({ addressList, delAddress }) {
            ...
            <div className="addressList-7">
              <div className="addressList-8">
                <div className="addressList-9">
                  <span className="addressList-10">{`${data?.name.toUpperCase()}${
  ...
  return (
    <div id="app" className="addressList-1">
      <div className="addressList-2">
        <div className="addressList-3">
          {translate(getText("錢包地址列表"))}
        </div>
        <div className="addressList-4">
          <div role="feed" className="addressList-5">
            {getAddressNodes()}
            <div className="addressList-15">
