...
class CustomDatafeed {
  ...
  async getHistoryKLineData(
    ...
    return fetch(url)
      ...
      .then((data) => {
        ...
        console.info(kLineData[kLineData.length - 1]);
    ...
    if (this.ws === null) {
      ...
      this.ws.onopen = () => {
        ...
        const subMessage = {
          ...
          sub: `market.${symbol.ticker.toLowerCase()}.kline.${nowTimeLever}`,
        };
        ...
        if (event.data instanceof Blob) {
          event.data.arrayBuffer().then((buffer) => {
            ...
            if (response.ping) {
              ...
              if (response.ch.includes(nowTimeLever)) {
  ...
  unsubscribe(symbol: SymbolInfo, period: Period): void {
    ...
    // const subMessage = {
    //   id: symbol.ticker.toLowerCase(),
    //   unsub: `market.${symbol.ticker.toLowerCase()}.kline.${huobiPeriod}`,
    // };
  }
