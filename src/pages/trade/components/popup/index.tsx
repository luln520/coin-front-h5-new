...
export default function CoinPopup({ isShow, setIsShow, coinListData, index,ctmarketlist }) {
    ...
    >
      ...
      <div className="coinPopupTopBar-1">
        <div className="coinPopupTopBar-2">
          ...
          >
            <span className="coinPopupTopBar-6">{translate(getText("期權"))}</span>
          </div>
          <div
            className={
          ...
          >
            <span className="coinPopupTopBar-8">{translate(getText("槓桿"))}</span>
          </div>
        </div>
      </div>
      <Search
      ...
      <div id="coinList" className="coinPopupTopCoinList-1">
        <div className="coinPopupTopCoinList-139">
          {getNodes()}
        </div>
      </div>
    </Popup>
