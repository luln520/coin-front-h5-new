          ...
          <div className="mycenter-12">
            <div className="mycenter-13">
              ...
              <div className="mycenter-17">
                <img src="/level/1.png" className="mycenter-19" />
      ...
      <div className="mycenter-29">
        ...
        {userInfo?.rzstatus == 2 && (
          ...
          >
            ...
            <p className="mycenter-36">
              {(userInfo?.rzstatus === 2 && userInfo?.cardsc)&&translate(getText(types[userInfo?.rzstatus]))}
              {!(userInfo?.rzstatus === 2 && userInfo?.cardsc)&&translate(getText(types[0]))}
            </p>
            <div className="mycenter-37">
              <img
                src="data:image/png;base64,"
